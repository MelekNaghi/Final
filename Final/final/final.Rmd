...
<!-- ============================== FOOTNOTES ============================== -->
<!-- ======================================================================= -->
[^1]: 20080159, [Github Repo](https://github.com/MelekNaghi/Final-Assignment.git)
...
The source of the data set has been reached from the official site of International Labour Organization (ILOSTAT). Three different data sets from the mentioned source gathered and data cleaning and clustering  operations done on the raw data. The reason that this study combines three different data sets in order to allow for more complex and close to reality analysis. Summary statistics of data set is given in (Table \ref{tab:summary_stats_men})  and (Table \ref{tab:summary_women})  containing mean, standard deviation, minimum, maximum, and median value for men and women in the labour force allowing to compare the differences if there is any. 
...
summary_stats_women <- female_df %>%
  select("25+", "Employed", "Unemployed", "Single", "Married", "Divorced or legally separated") %>% 
  descr(stats = c("mean", "sd", "min", "med", "max"), transpose = TRUE)

summary_stats_df_women <- as.data.frame(summary_stats_women)
```


```{r, echo=FALSE}
table_output_women <- xtable(summary_stats_df_women,
                             caption = "Summary Statistics For Women \\label{tab:summary_women}",
...
```{r, echo=FALSE}
summary_stats_men <- male_df %>%
  select("25+", "Employed", "Unemployed", "Single", "Married", "Divorced or legally separated") %>% 
  descr(stats = c("mean", "sd", "min", "med", "max"), transpose = TRUE)

summary_stats_df_men <- as.data.frame(summary_stats_men)
```


```{r, echo=FALSE, results='asis'}
print(summary_stats_df_men, booktabs = TRUE, comment = FALSE, caption.placement = "top")
print(summary_stats_df_women, booktabs = TRUE, comment = FALSE, caption.placement = "top")
